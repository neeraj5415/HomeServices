...
import AddServiceForm from "../../components/admin/AddService.jsx";
      ...
      <div className="p-6 w-full rounded-xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mt-10">
          {services.map((service, index) => (
            <div
            key={service._id}
            className={`${bgColors[index % bgColors.length]} p-4 rounded-lg shadow-md text-center hover:shadow-lg transition`}
            >
              <img
                src={service.image}
                alt={service.name}
