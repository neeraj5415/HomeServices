...
export default function ProviderProfile() {
  ...
  const fetchProfile = async () => {
    try {
      ...
      const res = await fetch("https://homeservices-5vng.onrender.com/api/auth/profile", {
  ...
  const fetchReviews = async () => {
    try {
      ...
      if (res.ok && userData._id) {
        const reviewsRes = await fetch(`https://homeservices-5vng.onrender.com/api/reviews/user/${userData._id}`);
